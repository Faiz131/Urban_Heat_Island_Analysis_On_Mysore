...
// Calculate NDBI using Landsat bands (B5: SWIR, B4: NIR for Landsat 5/7)
...
var ndbiCollection = landsatCollection.map(calculateNDBI);
...
Export.image.toDrive({
  ...
  description: 'Mysore_NDBI_2004_2014_Clipped',
  folder: 'GEE_Exports', // Specify your Google Drive folder
  fileNamePrefix: 'Mysore_NDBI_2004_2014_Clipped',
  region: mysore,
